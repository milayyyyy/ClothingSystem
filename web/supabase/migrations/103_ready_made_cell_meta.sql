...
-- Also allow describing a column header itself (shows in activity log for ready_made_columns changes)
alter table public.ready_made_columns
  add column if not exists description text;
...
comment on column public.ready_made_columns.description    is 'Optional description for this column header.';
