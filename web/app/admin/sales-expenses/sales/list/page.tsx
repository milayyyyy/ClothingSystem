...
export default async function AdminSalesListPage() {
  ...
  const { data: orders } = await supabase
    .from("orders")
    .select("id, order_no, customer_name, kind, order_type, source, notes, design_ref, status, stage, total, waybill_no, external_order_no, sku_code, return_status, updated_at, created_at")
