...
export function Sidebar({
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 px-5 py-5 pt-[max(1.25rem,env(safe-area-inset-top))]">
      ...
      <nav className="flex-1 overflow-y-auto px-3 pb-safe">
        {groups.map((g) => (
                    ...
                    <div key={item.href}>
                      ...
                      >
                        ...
                        <Link
                          ...
                          className="flex flex-1 items-center gap-2.5 px-3 py-2.5 text-sm font-medium"
                        >
